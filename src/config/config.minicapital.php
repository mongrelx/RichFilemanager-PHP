 ...
 */
$config['aclPolicy'] = \RFM\Repository\Minicapital\StorageHelper::ACL_POLICY_DEFAULT;
...
$config['credentials'] = [
    ...
    'defaultAcl' => \RFM\Repository\Minicapital\StorageHelper::ACL_PUBLIC_READ,
    'cdnHostname' => 'http://my.minicapital.net',
